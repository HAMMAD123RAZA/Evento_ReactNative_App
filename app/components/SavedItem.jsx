...
const SavedItem = () => {
  ...
  // Function to format saved items into readable text
  ...
  const sendEmail = async () => {
    try {
      ...
      // Prepare email content with readable format
      const emailOptions = {
        recipients: ['01hammadraza@gmail.com'], // Replace with your email
...
`}
      ...
      <FlatList data={savedItems} renderItem={renderItem} />
      <TouchableOpacity
